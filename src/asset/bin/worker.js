...
window.saveConnInfo = (data) => {
    workerMessage('saveConnInfo', data);
};

window.setLoadConnInfo = (callback) => {
    loadConnInfo = callback;
    workerMessage('loadConnInfo', {});
};

window.setInitSDK = (callback) => {
    initSDK = callback;
};
...
window.wsError = (reqId, constructor, data) => {
    workerMessage('wsError', {reqId, constructor, data});
};

window.authProgress = (progress) => {
    workerMessage('authProgress', {progress});
};

window.setReceive = (callback) => {
    receive = callback;
};

window.setWsOpen = (callback) => {
    wsOpen = callback;
};

window.setFnCall = (callback) => {
    fnCall = callback;
};

window.fnCallback = (reqId, constructor, data) => {
...
window.fnStarted = (duration, time) => {
...
window.setFnEncrypt = (callback) => {
    fnEncrypt = callback;
};

window.fnEncryptCallback = (reqId, b64) => {
...
window.setFnDecrypt = (callback) => {
    fnDecrypt = callback;
};

window.fnDecryptCallback = (reqId, constructor, data) => {
