...
goog.exportSymbol('proto.msg.UpdateGroupTitleUpdated', null, global);
...
proto.msg.UpdateGroupMemberAdded.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    chatversion: jspb.Message.getField(msg, 4),
    date: jspb.Message.getField(msg, 5)
  };
 ...
 * @return {number}
 */
proto.msg.UpdateGroupMemberAdded.prototype.getGroupid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.msg.UpdateGroupMemberAdded.prototype.setGroupid = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.msg.UpdateGroupMemberAdded.prototype.clearGroupid = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.UpdateGroupMemberAdded.prototype.hasGroupid = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.msg.UpdateGroupMemberDeleted.toObject = function(includeInstance, msg) {
  var f, obj = {
    groupid: jspb.Message.getField(msg, 1),
    userid: jspb.Message.getField(msg, 2),
    chatversion: jspb.Message.getField(msg, 3),
 ...
 * @return {number}
 */
proto.msg.UpdateGroupMemberDeleted.prototype.getGroupid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.msg.UpdateGroupMemberDeleted.prototype.setGroupid = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.msg.UpdateGroupMemberDeleted.prototype.clearGroupid = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.UpdateGroupMemberDeleted.prototype.hasGroupid = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @constructor
 */
proto.msg.UpdateGroupTitleUpdated = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.msg.UpdateGroupTitleUpdated, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.msg.UpdateGroupTitleUpdated.displayName = 'proto.msg.UpdateGroupTitleUpdated';
}
 ...
 * @return {!Object}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.UpdateGroupTitleUpdated.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.UpdateGroupTitleUpdated} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.UpdateGroupTitleUpdated.toObject = function(includeInstance, msg) {
  var f, obj = {
    groupid: jspb.Message.getField(msg, 1),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.UpdateGroupTitleUpdated}
 */
proto.msg.UpdateGroupTitleUpdated.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.UpdateGroupTitleUpdated;
  return proto.msg.UpdateGroupTitleUpdated.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.UpdateGroupTitleUpdated} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.UpdateGroupTitleUpdated}
 */
proto.msg.UpdateGroupTitleUpdated.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.UpdateGroupTitleUpdated.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.UpdateGroupTitleUpdated} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.UpdateGroupTitleUpdated.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {number} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.getGroupid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.msg.UpdateGroupTitleUpdated.prototype.setGroupid = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.msg.UpdateGroupTitleUpdated.prototype.clearGroupid = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.hasGroupid = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.msg.UpdateGroupTitleUpdated.prototype.setTitle = function(value) {
  jspb.Message.setField(this, 2, value);
};


proto.msg.UpdateGroupTitleUpdated.prototype.clearTitle = function() {
  jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.UpdateGroupTitleUpdated.prototype.hasTitle = function() {
  return jspb.Message.getField(this, 2) != null;
};
