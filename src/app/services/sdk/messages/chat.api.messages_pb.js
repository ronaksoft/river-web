...
goog.exportSymbol('proto.msg.MessagesBroadcastProgress', null, global);
...
proto.msg.MessagesSend.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cleardraft: jspb.Message.getField(msg, 7),
...
proto.msg.MessagesBroadcast.toObject = function(includeInstance, msg) {
  var f, obj = {
    body: jspb.Message.getField(msg, 1)
  };
 ...
 * @constructor
 */
proto.msg.MessagesBroadcastProgress = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.msg.MessagesBroadcastProgress, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.msg.MessagesBroadcastProgress.displayName = 'proto.msg.MessagesBroadcastProgress';
}
 ...
 * @return {!Object}
 */
proto.msg.MessagesBroadcastProgress.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.MessagesBroadcastProgress.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.MessagesBroadcastProgress} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.MessagesBroadcastProgress.toObject = function(includeInstance, msg) {
  var f, obj = {
    percentage: +jspb.Message.getField(msg, 1)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.MessagesBroadcastProgress}
 */
proto.msg.MessagesBroadcastProgress.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.MessagesBroadcastProgress;
  return proto.msg.MessagesBroadcastProgress.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.MessagesBroadcastProgress} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.MessagesBroadcastProgress}
 */
proto.msg.MessagesBroadcastProgress.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.msg.MessagesBroadcastProgress.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.MessagesBroadcastProgress.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.MessagesBroadcastProgress} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.MessagesBroadcastProgress.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {number} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeFloat(
...
/**
 * required float Percentage = 1;
 * @return {number}
 */
proto.msg.MessagesBroadcastProgress.prototype.getPercentage = function() {
  return /** @type {number} */ (+jspb.Message.getFieldWithDefault(this, 1, 0.0));
};


/** @param {number} value */
proto.msg.MessagesBroadcastProgress.prototype.setPercentage = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.msg.MessagesBroadcastProgress.prototype.clearPercentage = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.MessagesBroadcastProgress.prototype.hasPercentage = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.msg.MessagesSendMedia.toObject = function(includeInstance, msg) {
  var f, obj = {
    randomid: jspb.Message.getField(msg, 1),
    peer: (f = msg.getPeer()) && chat_core_types_pb.InputPeer.toObject(includeInstance, f),
    mediatype: jspb.Message.getField(msg, 3),
    mediadata: msg.getMediadata_asB64(),
    replyto: jspb.Message.getField(msg, 5),
    cleardraft: jspb.Message.getField(msg, 6)
  };
...
proto.msg.MessagesGetDialogs.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    excludepinned: jspb.Message.getField(msg, 4)
  };
...
proto.msg.MessagesClearHistory.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pb_delete: jspb.Message.getField(msg, 3)
  };
...
proto.msg.MessagesDelete.toObject = function(includeInstance, msg) {
  var f, obj = {
    peer: (f = msg.getPeer()) && chat_core_types_pb.InputPeer.toObject(includeInstance, f),
    messageidsList: jspb.Message.getRepeatedField(msg, 2),
    revoke: jspb.Message.getField(msg, 3)
  };
...
proto.msg.MessagesForward.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    silence: jspb.Message.getField(msg, 3),
    messageidsList: jspb.Message.getRepeatedField(msg, 4),
    randomid: jspb.Message.getField(msg, 5)
  };
...
proto.msg.MessagesSendScreenShotNotification.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    minid: jspb.Message.getField(msg, 4),
    maxid: jspb.Message.getField(msg, 5)
  };
...
proto.msg.MessagesMany.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    groupsList: jspb.Message.toObjectList(msg.getGroupsList(),
    chat_core_types_pb.Group.toObject, includeInstance),
    continuous: jspb.Message.getField(msg, 4)
  };
