...
goog.exportSymbol('proto.msg.FileGetMany', null, global);
goog.exportSymbol('proto.msg.FileMany', null, global);
 ...
 * @constructor
 */
proto.msg.FileGetMany = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.msg.FileGetMany.repeatedFields_, null);
};
goog.inherits(proto.msg.FileGetMany, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.msg.FileGetMany.displayName = 'proto.msg.FileGetMany';
}
/**
 ...
 * @const
 */
proto.msg.FileGetMany.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.msg.FileGetMany.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.FileGetMany.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.FileGetMany} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.FileGetMany.toObject = function(includeInstance, msg) {
  var f, obj = {
    filegetmanyList: jspb.Message.toObjectList(msg.getFilegetmanyList(),
    proto.msg.FileGet.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.FileGetMany}
 */
proto.msg.FileGetMany.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.FileGetMany;
  return proto.msg.FileGetMany.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.FileGetMany} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.FileGetMany}
 */
proto.msg.FileGetMany.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.msg.FileGet;
      reader.readMessage(value,proto.msg.FileGet.deserializeBinaryFromReader);
      msg.addFilegetmany(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.msg.FileGetMany.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.FileGetMany.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.FileGetMany} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.FileGetMany.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFilegetmanyList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.msg.FileGet.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated FileGet FileGetMany = 1;
 * @return {!Array.<!proto.msg.FileGet>}
 */
proto.msg.FileGetMany.prototype.getFilegetmanyList = function() {
  return /** @type{!Array.<!proto.msg.FileGet>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.msg.FileGet, 1));
};


/** @param {!Array.<!proto.msg.FileGet>} value */
proto.msg.FileGetMany.prototype.setFilegetmanyList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.msg.FileGet=} opt_value
 * @param {number=} opt_index
 * @return {!proto.msg.FileGet}
 */
proto.msg.FileGetMany.prototype.addFilegetmany = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.msg.FileGet, opt_index);
};


proto.msg.FileGetMany.prototype.clearFilegetmanyList = function() {
  this.setFilegetmanyList([]);
};
 ...
 * @constructor
 */
proto.msg.FileMany = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.msg.FileMany.repeatedFields_, null);
};
goog.inherits(proto.msg.FileMany, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.msg.FileMany.displayName = 'proto.msg.FileMany';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.msg.FileMany.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.msg.FileMany.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.FileMany.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.FileMany} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.FileMany.toObject = function(includeInstance, msg) {
  var f, obj = {
    filemanyList: jspb.Message.toObjectList(msg.getFilemanyList(),
    proto.msg.File.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.FileMany}
 */
proto.msg.FileMany.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.FileMany;
  return proto.msg.FileMany.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.FileMany} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.FileMany}
 */
proto.msg.FileMany.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.msg.File;
      reader.readMessage(value,proto.msg.File.deserializeBinaryFromReader);
      msg.addFilemany(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.msg.FileMany.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.FileMany.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.FileMany} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.FileMany.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFilemanyList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.msg.File.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated File FileMany = 1;
 * @return {!Array.<!proto.msg.File>}
 */
proto.msg.FileMany.prototype.getFilemanyList = function() {
  return /** @type{!Array.<!proto.msg.File>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.msg.File, 1));
};


/** @param {!Array.<!proto.msg.File>} value */
proto.msg.FileMany.prototype.setFilemanyList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.msg.File=} opt_value
 * @param {number=} opt_index
 * @return {!proto.msg.File}
 */
proto.msg.FileMany.prototype.addFilemany = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.msg.File, opt_index);
};


proto.msg.FileMany.prototype.clearFilemanyList = function() {
  this.setFilemanyList([]);
};
