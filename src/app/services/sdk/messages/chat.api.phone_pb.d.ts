...
export class PhoneAcceptCall extends jspb.Message {
  hasPeer(): boolean;
  clearPeer(): void;
  getPeer(): chat_core_types_pb.InputUser;
  setPeer(value?: chat_core_types_pb.InputUser): void;
...
export namespace PhoneAcceptCall {
  export type AsObject = {
    peer: chat_core_types_pb.InputUser.AsObject,
