...
proto.msg.UpdateBotInlineQuery.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    geo: (f = msg.getGeo()) && chat_core_types_pb.GeoLocation.toObject(includeInstance, f)
  };
...
proto.msg.UpdateBotInlineQuery.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new chat_core_types_pb.GeoLocation;
      reader.readMessage(value,chat_core_types_pb.GeoLocation.deserializeBinaryFromReader);
      msg.setGeo(value);
      break;
    default:
      reader.skipField();
...
proto.msg.UpdateBotInlineQuery.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      chat_core_types_pb.GeoLocation.serializeBinaryToWriter
    );
  }
};
...
proto.msg.UpdateBotInlineQuery.prototype.getGeo = function() {
  return /** @type{?proto.msg.GeoLocation} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.GeoLocation, 6));
};
...
proto.msg.UpdateBotInlineSend.prototype.getGeo = function() {
  return /** @type{?proto.msg.GeoLocation} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.GeoLocation, 5));
};
