...
goog.exportSymbol('proto.msg.NotifyFlags', null, global);
goog.exportSymbol('proto.msg.NotifySettings', null, global);
 ...
 * @constructor
 */
proto.msg.NotifySettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.msg.NotifySettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.msg.NotifySettings.displayName = 'proto.msg.NotifySettings';
}
 ...
 * @return {!Object}
 */
proto.msg.NotifySettings.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.NotifySettings.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.NotifySettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.NotifySettings.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.msg.NotifySettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.NotifySettings;
  return proto.msg.NotifySettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.NotifySettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.NotifySettings}
 */
proto.msg.NotifySettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.msg.NotifySettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.NotifySettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.NotifySettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.NotifySettings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {number} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeFixed32(
 ...
 * @return {number}
 */
proto.msg.NotifySettings.prototype.getFlags = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.msg.NotifySettings.prototype.setFlags = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.msg.NotifySettings.prototype.clearFlags = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.NotifySettings.prototype.hasFlags = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.msg.NotifySettings.prototype.getMuteuntil = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.msg.NotifySettings.prototype.setMuteuntil = function(value) {
  jspb.Message.setField(this, 2, value);
};


proto.msg.NotifySettings.prototype.clearMuteuntil = function() {
  jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.NotifySettings.prototype.hasMuteuntil = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {string}
 */
proto.msg.NotifySettings.prototype.getSound = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.msg.NotifySettings.prototype.setSound = function(value) {
  jspb.Message.setField(this, 3, value);
};


proto.msg.NotifySettings.prototype.clearSound = function() {
  jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {!boolean}
 */
proto.msg.NotifySettings.prototype.hasSound = function() {
  return jspb.Message.getField(this, 3) != null;
};
