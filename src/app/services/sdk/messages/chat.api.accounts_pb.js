...
goog.exportSymbol('proto.msg.LangCode', null, global);
...
proto.msg.AccountSetLang.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.msg.LangCode} */ (reader.readEnum());
      msg.setLangcode(value);
      break;
    default:
      reader.skipField();
...
proto.msg.AccountSetLang.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {!proto.msg.LangCode} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeEnum(
      1,
      f
...
/**
 * required LangCode LangCode = 1;
 * @return {!proto.msg.LangCode}
 */
proto.msg.AccountSetLang.prototype.getLangcode = function() {
  return /** @type {!proto.msg.LangCode} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.msg.LangCode} value */
