...
goog.exportSymbol('proto.msg.AuthRequestPasswordRecovery', null, global);
 ...
 * @constructor
 */
proto.msg.AuthRequestPasswordRecovery = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.msg.AuthRequestPasswordRecovery, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.msg.AuthRequestPasswordRecovery.displayName = 'proto.msg.AuthRequestPasswordRecovery';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.msg.AuthCheckPassword.prototype.getPassword = function() {
  return /** @type{!proto.msg.InputPassword} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputPassword, 1, 1));
};
 ...
 * @return {!Object}
 */
proto.msg.AuthRequestPasswordRecovery.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.AuthRequestPasswordRecovery.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.AuthRequestPasswordRecovery} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.AuthRequestPasswordRecovery.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.AuthRequestPasswordRecovery}
 */
proto.msg.AuthRequestPasswordRecovery.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.AuthRequestPasswordRecovery;
  return proto.msg.AuthRequestPasswordRecovery.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.AuthRequestPasswordRecovery} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.AuthRequestPasswordRecovery}
 */
proto.msg.AuthRequestPasswordRecovery.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.msg.AuthRequestPasswordRecovery.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.AuthRequestPasswordRecovery.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.AuthRequestPasswordRecovery} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.AuthRequestPasswordRecovery.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
...
proto.msg.AuthBotAuthorization.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    bot: (f = msg.getBot()) && chat_core_types_pb.Bot.toObject(includeInstance, f)
  };
...
proto.msg.AuthBotAuthorization.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new chat_core_types_pb.Bot;
      reader.readMessage(value,chat_core_types_pb.Bot.deserializeBinaryFromReader);
      msg.setBot(value);
      break;
    default:
      reader.skipField();
...
proto.msg.AuthBotAuthorization.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      chat_core_types_pb.Bot.serializeBinaryToWriter
    );
  }
};
...
proto.msg.AuthBotAuthorization.prototype.getBot = function() {
  return /** @type{!proto.msg.Bot} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.Bot, 3, 1));
};
