...
proto.msg.GroupsCreate.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    chat_core_types_pb.InputUser.toObject, includeInstance),
...
proto.msg.GroupsUploadPhoto.prototype.getFile = function() {
  return /** @type{!proto.msg.InputFile} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputFile, 2, 1));
};
...
proto.msg.GroupsRemovePhoto.toObject = function(includeInstance, msg) {
  var f, obj = {
    groupid: jspb.Message.getField(msg, 1),
    photoid: jspb.Message.getField(msg, 2)
  };
