...
goog.exportSymbol('proto.msg.BotIsStarted', null, global);
 ...
 * @constructor
 */
proto.msg.BotIsStarted = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.msg.BotIsStarted, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.msg.BotIsStarted.displayName = 'proto.msg.BotIsStarted';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.msg.BotIsStarted.prototype.toObject = function(opt_includeInstance) {
  return proto.msg.BotIsStarted.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.msg.BotIsStarted} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.BotIsStarted.toObject = function(includeInstance, msg) {
  var f, obj = {
    bot: (f = msg.getBot()) && chat_core_types_pb.InputPeer.toObject(includeInstance, f),
    randomid: (f = jspb.Message.getField(msg, 2)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.msg.BotIsStarted}
 */
proto.msg.BotIsStarted.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.msg.BotIsStarted;
  return proto.msg.BotIsStarted.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.msg.BotIsStarted} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.msg.BotIsStarted}
 */
proto.msg.BotIsStarted.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.msg.BotIsStarted.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.msg.BotIsStarted.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.msg.BotIsStarted} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.msg.BotIsStarted.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBot();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {!proto.msg.InputPeer}
 */
proto.msg.BotIsStarted.prototype.getBot = function() {
  return /** @type{!proto.msg.InputPeer} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputPeer, 1, 1));
};
...
/**
 * @param {!proto.msg.InputPeer} value
 * @return {!proto.msg.BotIsStarted} returns this
*/
proto.msg.BotIsStarted.prototype.setBot = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.msg.BotIsStarted} returns this
 */
proto.msg.BotIsStarted.prototype.clearBot = function() {
  return jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {boolean}
 */
proto.msg.BotIsStarted.prototype.hasBot = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.msg.BotIsStarted.prototype.getRandomid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.msg.BotIsStarted} returns this
 */
proto.msg.BotIsStarted.prototype.setRandomid = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.msg.BotIsStarted} returns this
 */
proto.msg.BotIsStarted.prototype.clearRandomid = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.msg.BotIsStarted.prototype.hasRandomid = function() {
  return jspb.Message.getField(this, 2) != null;
};
