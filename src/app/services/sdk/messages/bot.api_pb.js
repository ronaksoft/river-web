...
var chat_api_wallpaper_pb = require('./chat.api.wallpaper_pb.js');
goog.object.extend(proto, chat_api_wallpaper_pb);
...
proto.msg.BotUpdatePhoto.prototype.getFile = function() {
  return /** @type{?proto.msg.InputFileLocation} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputFileLocation, 1));
};
...
proto.msg.BotGetInlineResults.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    location: (f = msg.getLocation()) && chat_core_types_pb.InputGeoLocation.toObject(includeInstance, f)
  };
...
proto.msg.BotGetInlineResults.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new chat_core_types_pb.InputGeoLocation;
      reader.readMessage(value,chat_core_types_pb.InputGeoLocation.deserializeBinaryFromReader);
...
proto.msg.BotGetInlineResults.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      chat_core_types_pb.InputGeoLocation.serializeBinaryToWriter
    );
  }
};
...
proto.msg.BotGetInlineResults.prototype.getLocation = function() {
  return /** @type{?proto.msg.InputGeoLocation} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputGeoLocation, 5));
};
...
proto.msg.BotSendInlineResults.prototype.getPeer = function() {
  return /** @type{!proto.msg.InputPeer} */ (
    jspb.Message.getWrapperField(this, chat_core_types_pb.InputPeer, 5, 1));
};
...
proto.msg.BotUploadWallPaper.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    settings: (f = msg.getSettings()) && chat_api_wallpaper_pb.WallPaperSettings.toObject(includeInstance, f)
  };
...
proto.msg.BotUploadWallPaper.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new chat_api_wallpaper_pb.WallPaperSettings;
      reader.readMessage(value,chat_api_wallpaper_pb.WallPaperSettings.deserializeBinaryFromReader);
...
proto.msg.BotUploadWallPaper.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      chat_api_wallpaper_pb.WallPaperSettings.serializeBinaryToWriter
    );
  }
};
...
proto.msg.BotUploadWallPaper.prototype.getSettings = function() {
  return /** @type{!proto.msg.WallPaperSettings} */ (
    jspb.Message.getWrapperField(this, chat_api_wallpaper_pb.WallPaperSettings, 4, 1));
};
...
proto.msg.BotInlineResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    thumb: (f = msg.getThumb()) && chat_core_message_medias_pb.MediaWebDocument.toObject(includeInstance, f),
...
proto.msg.BotInlineResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new chat_core_message_medias_pb.MediaWebDocument;
      reader.readMessage(value,chat_core_message_medias_pb.MediaWebDocument.deserializeBinaryFromReader);
      msg.setThumb(value);
      break;
    case 7:
...
proto.msg.BotInlineResult.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      chat_core_message_medias_pb.MediaWebDocument.serializeBinaryToWriter
    );
  }
...
proto.msg.BotInlineResult.prototype.getThumb = function() {
  return /** @type{?proto.msg.MediaWebDocument} */ (
    jspb.Message.getWrapperField(this, chat_core_message_medias_pb.MediaWebDocument, 6));
};
...
proto.msg.InputBotInlineResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    description: (f = jspb.Message.getField(msg, 4)) == null ? undefined : f,
    url: (f = jspb.Message.getField(msg, 5)) == null ? undefined : f,
    thumb: (f = msg.getThumb()) && chat_core_message_medias_pb.InputMediaWebDocument.toObject(includeInstance, f),
...
proto.msg.InputBotInlineResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new chat_core_message_medias_pb.InputMediaWebDocument;
      reader.readMessage(value,chat_core_message_medias_pb.InputMediaWebDocument.deserializeBinaryFromReader);
      msg.setThumb(value);
      break;
    case 8:
...
proto.msg.InputBotInlineResult.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      chat_core_message_medias_pb.InputMediaWebDocument.serializeBinaryToWriter
    );
  }
  f = message.getMessage();
  if (f != null) {
...
proto.msg.InputBotInlineResult.prototype.getThumb = function() {
  return /** @type{?proto.msg.InputMediaWebDocument} */ (
    jspb.Message.getWrapperField(this, chat_core_message_medias_pb.InputMediaWebDocument, 6));
};
...
proto.msg.BotInlineMessage.prototype.getEntitiesList = function() {
  return /** @type{!Array<!proto.msg.MessageEntity>} */ (
    jspb.Message.getRepeatedWrapperField(this, chat_core_types_pb.MessageEntity, 11));
};
