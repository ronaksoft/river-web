...
import {AddRounded, CheckRounded, EditRounded} from '@material-ui/icons';
...
class UserDialog extends React.Component<IProps, IState> {
    ...
    public render() {
        const {user, edit, firstname, lastname, phone, isInContact, dialog, notifySettingDialogOpen, notifyValue, userDialogOpen} = this.state;
        return (
            <Dialog
                open={userDialogOpen}
