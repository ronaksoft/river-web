/* eslint-disable */
import EXIF from "browser-image-resizer/build/exif";
...
function scaleCanvasWithAlgorithm(canvas, config) {
    ...
    var srcImgData = canvas
        .getContext('2d')
        .getImageData(0, 0, canvas.width || 1, canvas.height || 1);
    var destImgData = scaledCanvas
        .getContext('2d')
        .createImageData(scaledCanvas.width || 1, scaledCanvas.height || 1);
...
function getHalfScaleCanvas(canvas) {
    ...
    halfCanvas.width = (canvas.width / 2 || 1);
    halfCanvas.height = (canvas.height / 2 || 1);

    halfCanvas
        .getContext('2d')
        .drawImage(canvas, 0, 0, halfCanvas.width || 1, halfCanvas.height || 1);
